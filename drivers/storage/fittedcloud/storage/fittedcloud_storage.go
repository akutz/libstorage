...
import (
	...
	"github.com/codedellemc/libstorage/drivers/storage/fittedcloud/fcagent"
...
type driver struct {
	...
	accessKey  string
	kmsKeyID   string
	executor   types.StorageExecutor
	fcTag      string
}
...
func (d *driver) Init(context types.Context, config gofig.Config) error {
	...
	d.fcTag = fcTag
	d.executor, _ = registry.NewStorageExecutor(d.Name())
...
func (d *driver) VolumeAttach(
	...
	for _, volume := range ec2vols {
		...
		nextDevice, err = d.executor.NextDevice(ctx, apiUtils.NewStore())
	}
